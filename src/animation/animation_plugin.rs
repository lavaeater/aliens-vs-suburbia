...
impl Plugin for AnimationPlugin {
    fn build(&self, app: &mut App) {
        app.add_event::<AnimationEvent>()
            .add_systems(OnEnter(GameState::InGame), load_animations)
            .add_systems(
                Update,
                (
...
pub fn load_animations(mut commands: Commands, asset_server: Res<AssetServer>) {
    let mut store = AnimationStore::<String> {
        anims: HashMap::new(),
    };
    store.anims.insert("aliens".into(), HashMap::new());
    let alien_anims = store.anims.get_mut("aliens").unwrap();
    alien_anims.insert(
    ...
    store.anims.insert("hazmat".into(), HashMap::new());
    let hazmat_anims = store.anims.get_mut("hazmat").unwrap();

    hazmat_anims.insert(
        AnimationKey::Yes,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation16"),
    );
    hazmat_anims.insert(
        AnimationKey::Wave,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation15"),
    );
    hazmat_anims.insert(
        AnimationKey::WalkShoot,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation14"),
    );
    hazmat_anims.insert(
        AnimationKey::Walk,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation13"),
    );
    hazmat_anims.insert(
        AnimationKey::RunShoot,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation12"),
    );
    hazmat_anims.insert(
        AnimationKey::RunGun,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation5"),
    );
    hazmat_anims.insert(
        AnimationKey::Run,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation10"),
    );
    hazmat_anims.insert(
        AnimationKey::Punch,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation9"),
    );
    hazmat_anims.insert(
        AnimationKey::No,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation8"),
    );
    hazmat_anims.insert(
        AnimationKey::JumpLand,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation7"),
    );
    hazmat_anims.insert(
        AnimationKey::JumpIdle,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation6"),
    );
    hazmat_anims.insert(
        AnimationKey::Jump,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation11"),
    );
    hazmat_anims.insert(
        AnimationKey::IdleShoot,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation4"),
    );
    hazmat_anims.insert(
        AnimationKey::Idle,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation3"),
    );
    hazmat_anims.insert(
        AnimationKey::HitReact,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation2"),
    );
    hazmat_anims.insert(
        AnimationKey::Duck,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation1"),
    );
    hazmat_anims.insert(
        AnimationKey::Death,
        asset_server.load("toon-shooter/char-hazmat.glb#Animation0"),
    );

    store.anims.insert("players".into(), HashMap::new());
    let player_anims = store.anims.get_mut("players").unwrap();
    player_anims.insert(
        AnimationKey::Idle,
        asset_server.load("girl/girl.glb#Animation0"),
    );
    player_anims.insert(
        AnimationKey::Walking,
        asset_server.load("girl/girl.glb#Animation1"),
    );
    player_anims.insert(
        AnimationKey::Throwing,
        asset_server.load("girl/girl.glb#Animation2"),
    );
    player_anims.insert(
        AnimationKey::Crawling,
        asset_server.load("girl/girl.glb#Animation3"),
    );
    player_anims.insert(
        AnimationKey::Building,
        asset_server.load("girl/girl.glb#Animation4"),
    );
...
pub fn get_parent_recursive(entity: Entity, parent_query: &Query<&Parent>) -> Option<Entity> {
    match parent_query.get(entity) {
        Ok(parent) => get_parent_recursive(parent.get(), parent_query),
        Err(_) => Some(entity),
    }
}

pub fn get_child_with_component_recursive<T: Component>(
    entity: Entity,
    child_query: &Query<&Children>,
    component_query: &Query<&mut T>,
) -> Option<Entity> {
