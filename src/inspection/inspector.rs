...
fn inspector_ui(world: &mut World) {
    ...
    egui::Window::new("UI").show(egui_context.get_mut(), |ui| {
        egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            bevy_inspector_egui::bevy_inspector::ui_for_world_entities_filtered::<With<Player>>(
                world, ui, true,
            );
            // bevy_inspector_egui::bevy_inspector::ui_for_world_entities_filtered::<With<Floor>>(world, ui, true);
            bevy_inspector_egui::bevy_inspector::ui_for_world_entities_filtered::<With<GameCamera>>(
                world, ui, true,
            );
        });
    });
