...
use crate::general::components::map_components::{MapModelDefinitions, ModelDefinition};
...
use crate::general::systems::map_systems::{
    load_map_one, map_loader, update_current_tile_system, TileDefinitions,
};
...
impl Plugin for NonStateMapStuff {
    fn build(&self, app: &mut App) {
        app.add_event::<LoadMap>()
            ...
            .insert_resource(TileDefinitions::new(
                1.0,
                32.0,
                9.5,
                1.0,
