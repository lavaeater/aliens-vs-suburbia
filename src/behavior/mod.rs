...
// #[reflect(Default)]
// #[type_path = "avs"]
// pub enum EnemyBehaviors {
//     #[default]
//     Idle, //Default state when we spawn
//     MoveTowardsGoal,
//     AttackObstacle,
//     FindRouteToGoal
// }
...
//                 (Success, 0.0)
//             },
//             EnemyBehaviors::HasActionPointsLeft => {
...
//         Box::new(Action(EnemyBehaviors::HasActionPointsLeft)),
//         vec![Action(EnemyBehaviors::Run), Action(EnemyBehaviors::Shoot)],
//     );
//     let top_ai = WhileAll(
