...
use crate::control::components::{ControlCommands, ControlDirection, CharacterControl, ControlRotation, KeyboardInput};
...
pub fn input_control(
    ...
    mut query: Query<(Entity, &mut CharacterControl), With<KeyboardInput>>,
